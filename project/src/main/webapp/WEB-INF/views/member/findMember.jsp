...
<title>아이디 | 비밀번호 찾기 - TellBook</title>
<!-- 파비콘 -->
				...
				<div class="accordion" id="accordionExample">
					<div class="accordion-item">
						<h2 class="accordion-header" id="headingOne">
							<button class="accordion-button" type="button"
								...
								aria-expanded="true" aria-controls="collapseOne">회원 정보에
								등록된 이름과 이메일로 ID 찾기</button>
						</h2>
						<div id="collapseOne" class="accordion-collapse collapse show"
							...
							<div class="accordion-body">
								<div class="mb-3">
									...
									<input type="text" class="i_name form-control"
										name="memberName" placeholder="이름">
									<p class="name_check" style="display: none; color: red">
										<strong>이름을 입력해주세요.</strong>
									</p>
								</div>
								<div class="mb-3">
									<label for="exampleFormControlInput1" class="form-label">이메일</label>
									<input type="email" class="i_email form-control"
										name="memberMail" placeholder="이메일(name@example.com)">
									<p class="email_check" style="display: none; color: red">
										<strong>알맞은 이메일 형식을 입력해주세요.</strong>
									</p>
								</div>
								<div class="d-grid gap-2 col-6 mx-auto">
									<button class="btn btn-success" style="margin-top: 10px;"
										onclick="find_ID();">찾기</button>
								</div>
							</div>
						</div>
					</div>
					<div class="accordion-item">
						<h2 class="accordion-header" id="headingTwo">
							<button class="accordion-button collapsed" type="button"
								...
								aria-expanded="false" aria-controls="collapseTwo">아이디와
								이메일을 입력하고 비밀번호 재설정</button>
						</h2>
						<div id="collapseTwo" class="accordion-collapse collapse"
							...
							<div class="accordion-body">
								<div class="mb-3">
									...
									<input type="text" class="i_id form-control" name="memberId"
										placeholder="아이디">
									<p class="id_check" style="display: none; color: red">
										<strong>아이디를 입력해주세요.</strong>
									</p>
								</div>
								<div class="mb-3">
									<label for="exampleFormControlInput1" class="form-label">이메일</label>
									<input type="email" class="i_email2 form-control"
										name="memberMail" placeholder="이메일(name@example.com)">
									<p class="email_check2" style="display: none; color: red">
										<strong>알맞은 이메일 형식을 입력해주세요.</strong>
									</p>
									<p class="check_success" style="display: none; color: green;">
										<strong>회원님의 계정을 확인했습니다.</strong>
									</p>
								</div>
								<div class="d-grid gap-2 col-6 mx-auto">
									<button class="btn btn-success join_check"
										style="margin-top: 10px;" onclick="find_Pw();">가입여부
										확인</button>
									<button class="btn btn-success send_number"
										style="margin-top: 10px; display: none;"
										onclick="send_Mail();">이메일 인증</button>
								</div>
								<div class="mb-3 iden_div" style="display: none">
									<label for="exampleFormControlInput1" class="form-label">입력한
										이메일로 인증번호를 전송했습니다. 입력칸에 입력해주세요.</label> <input type="text"
										class="iden_number form-control" name="iden_number"
										placeholder="인증번호">
									<p class="iden_checkFail" style="display: none; color: red;">
										<strong>인증번호가 일치하지 않습니다.</strong>
									</p>
								</div>
								<div class="d-grid gap-2 col-6 mx-auto iden_btndiv">
									<button class="btn btn-success iden-btn"
										style="margin-top: 10px; display: none;"
										onclick="iden_Check();">확인</button>
								</div>
							</div>
						</div>
					</div>
						...
						<div class="modal-dialog modal-dialog-centered">
							<div class="modal-content">
								...
								<div class="modal-footer">
									...
									<button type="button" class="btn btn-secondary replace_btn"
					...
					<div class="modal fade" id="exampleModalToggle2" aria-hidden="true"
						...
						<div class="modal-dialog modal-dialog-centered">
							<div class="modal-content">
								<div class="modal-header">
									<h5 class="modal-title" id="exampleModalToggleLabel2">비밀번호
										재설정</h5>
									<button type="button" class="btn-close" data-bs-dismiss="modal"
										aria-label="Close"></button>
								</div>
								<div class="modal-body">
									<div class="mb-3">
										<label for="exampleFormControlInput1" class="form-label">새
											비밀번호</label> <input type="password" class="i_password form-control"
											name="memberPw" placeholder="새 비밀번호">
										<p class="final_pw_ck" style="display: none; color: red;">
											<strong>비밀번호를 입력해주세요.</strong>
										</p>
										<p class="valiation_pw" style="display: none; color: red">
											<strong>비밀번호 형식에 어긋납니다.</strong>
										</p>
										<label for="exampleFormControlInput1" class="form-label">비밀번호
											확인</label> <input type="password" class="i_passwordCk form-control"
											name="memberPwCk" placeholder="비밀번호 확인">
										<p class="final_pwck_ck" style="display: none; color: red;">
											<strong>비밀번호를 입력해주세요.</strong>
										</p>
										<p class="pwck_input_re_1"
											style="display: none; color: green;">
											<strong>비밀번호가 일치합니다.</strong>
										</p>
										<p class="pwck_input_re_2" style="display: none; color: red;">
...
<script>
	...
	// 비밀번호 확인 일치 유효성 검사
	$('.i_passwordCk').on("propertychange change keyup paste input",
			function() {
