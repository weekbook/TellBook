		...
		<div class="admin_content_main">
			<form action="/admin/goodsModify" method="post" id="modifyForm">
				...
				<div class="form_section">
					...
					<div class="form_section_content">
						<input class="form-control" name="publisher"
							value="${goodsInfo.publisher}"> <span
					...
					<div class="form_section_content">
						...
						<div class="cate_wrap">
							<span>소분류</span> <select class="cate3 form-select"
								name="cateCode" style="display: inline-block;">
								<option selected value="none">선택</option>
							</select>
						</div>
				...
				<div class="form_section">
					...
					<div class="form_section_content">
						<input class="form-control" name="bookPrice"
							value="${goodsInfo.bookPrice}"> <span
				...
				<div class="form_section">
					...
					<div class="form_section_content">
						<input class="form-control" name="bookStock"
							value="${goodsInfo.bookStock}"> <span
				...
				<div class="form_section">
					...
					<div class="form_section_content">
						<input class="form-control" id="discount_interface" maxlength="2"
							value="0"> <input name="bookDiscount" type="hidden"
			...
			<div class="btn_section">
				...
				<button id="deleteBtn" class="btn delete_btn btn-danger">삭제</button>
			</div>
		</div>
...
<!-- 두 번째 스크립트는 렌더링 될 때 실행될 코드와 구분하기 위해서 새로운 스크립트를 생성한것 -->
<script>
	/* 카테고리 */
	let cateList = JSON.parse('${cateList}');
